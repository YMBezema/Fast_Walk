...
### How to FWOC ###
Gamepad - With your left stick, you can now precisely control your walking speed all the way to the brisk walking speed you get 
when 'running' in camp.

Keyboard - Mod  is currently a bit broken when using a keyboard. I strongly recommend Jewel's Scroll Wheel Movement Speed Control instead, which I have personally used a lot until I decided I preferred using a pad for RDR2 https://www.nexusmods.com/reddeadredemption2/mods/441.
